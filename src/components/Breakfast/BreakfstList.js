...
const BreakfstList = (props) => {
    return (
        <section className='brkfst'>
            <div className='brkfst-item'>
                <div className='brkfst-img d-flex align-items-center'>
                ...
                <Link to='/location'><button onClick={() => props.handleBrkfst(props.data)} className='btn btn-danger'>Add cart</button></Link>
            </div>
        </section>
    );
};

export default BreakfstList;