    ...
    return (
        <section className='dinner'>
            <div className='dinner-item'>
                <div className='dinner-img d-flex align-items-center'>
                ...
                <Link to='/location'><button onClick={() => props.handleDinner(props.data)} className='btn btn-danger'>Add cart</button></Link>
            </div>
        </section>
    );
};
